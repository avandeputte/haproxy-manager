...
const PAGE_IDS = new Set(["applybtn", "banner", "brandhost", "content", "dlg", "dlgbody", "dlgclose", "dlgfoot", "dlgtitle", "lbtn", "lcode", "lcodewrap", "lerr", "login", "loginbox", "loginintro", "logintitle", "lp", "lp2", "lp2wrap", "lu", "main", "nav", "navlinks", "navtoggle", "nodestrip", "ovl", "pagetitle", "scrim", "topbar", "whofoot"]);
