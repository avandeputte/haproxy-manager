...
```bash
# Debian / Ubuntu
curl -fsSLO https://github.com/avandeputte/haproxy-manager/releases/latest/download/haproxy-manager_1.66.0_all.deb
sudo apt-get install -y ./haproxy-manager_1.66.0_all.deb

# Fedora
curl -fsSLO https://github.com/avandeputte/haproxy-manager/releases/latest/download/haproxy-manager-1.66.0-1.noarch.rpm
sudo dnf install -y ./haproxy-manager-1.66.0-1.noarch.rpm
