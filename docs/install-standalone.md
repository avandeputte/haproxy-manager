...
```bash
# Debian / Ubuntu
curl -fsSLO https://github.com/avandeputte/haproxy-manager/releases/latest/download/haproxy-manager_1.90.2_all.deb
sudo apt-get install -y ./haproxy-manager_1.90.2_all.deb

# Fedora
curl -fsSLO https://github.com/avandeputte/haproxy-manager/releases/latest/download/haproxy-manager-1.90.2-1.noarch.rpm
sudo dnf install -y ./haproxy-manager-1.90.2-1.noarch.rpm
